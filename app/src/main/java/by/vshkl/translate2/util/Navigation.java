...
public class Navigation {
    ...
    public static void navigateToMap(final Context context) {
        context.startActivity(MapActivity.newIntent(context));
    }

    public static void navigateToAppSettings(final Context context) {
    ...
    public static void navigateToSettings(final Context context) {
