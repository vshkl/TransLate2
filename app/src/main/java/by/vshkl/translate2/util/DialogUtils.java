...
public class DialogUtils {
    ...
    public static void showLocationRationaleDialog(final Context context, final PermissionRequest request) {
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.map_permission_rationale_allow, (dialog, which) -> request.proceed())
                .setNegativeButton(R.string.map_permission_rationale_deny, (dialog, which) -> request.cancel())
                .show();
    }
    ...
    public static void showLocationTurnOnDialog(final Context context) {
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.map_location_ok, (dialog, which) -> Navigation.navigateToLocationSettings(context))
                .setNegativeButton(R.string.map_location_cancel, (dialog, which) -> {
                })
                .show();
    }
}
